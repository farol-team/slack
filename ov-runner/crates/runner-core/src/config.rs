...
const KEYRING_SERVICE: &str = "io.yourservice.ov-runner";
const KEYRING_USER: &str = "cloud-token";

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct RunnerConfig {
    /// Cloud endpoint, e.g. "wss://api.yourservice.io/runner/v1".
...
impl Default for RunnerConfig {
    fn default() -> Self {
        Self {
            cloud_url: "wss://api.yourservice.io/runner/v1".into(),
            workspace_id: None,
            agents: vec![
                AgentEntry {
...
impl RunnerConfig {
    fn config_path() -> Result<PathBuf> {
        let dirs = ProjectDirs::from("io", "yourservice", "ov-runner")
